...
``IEEE Standard 1003.1`` – Это официальный документ, в котором описан стандарт POSIX. В ннем определено: как должен работать shell; какие системные вызовы есть; какие команды должны присутствовать.
